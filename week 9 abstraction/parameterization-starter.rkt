...
;; given fn lon, produces a filtered lift with every n if fn(lon n) = true
...
(check-expect (filter2 integer? (list 1 -2 3 -4)) (list 1 -2 3 -4))
(check-expect (filter2 number? (list 1 -2 3 -4)) (list 1 -2 3 -4))
